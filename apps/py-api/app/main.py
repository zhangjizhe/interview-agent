...
from app.api.routes import interview, interview_more, question_bank, admin_tools, auth, health, metrics as metrics_route
...
def create_app() -> FastAPI:
    ...
    # 顺序：question_bank/admin_tools 必须在 interview_more 之前 include
    # 否则 /{interview_id} 会拦截 /question-bank/list, /admin/mcp-servers 等
    app.include_router(question_bank.router, prefix="/api", tags=["question_bank"])
    app.include_router(admin_tools.router, prefix="/api", tags=["admin_tools"])
